...
import { Input, RectangleBtn, CancleBtn } from "../shared/theme";
        ...
        <React.Fragment>
            <Form>
                ...
                <BtnBox>
                    ...
                    <RectangleBtn type="button" onClick={handleSubmit}>일정 추가하기</RectangleBtn>
                </BtnBox>
            </Form>
        </React.Fragment>
    );
